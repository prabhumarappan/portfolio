    ...
    return (
        <section id="about" className="text-center">
            <div className="py-10 xl:w-2/4 mx-auto">
                ...
                <p className="text-xl pt-10">I'm currently doing my Master of Science in Computer Science from Portland State University.</p>
                <br/>
            ...
            <div className="py-10 xl:w-2/3 mx-auto">
                ...
                <ul className="py-10 pb-0 mx-auto flex flex-wrap">
                    ...
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">Javascript</li>
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">Java</li>
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">MongoDB</li>
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">PostgreSQL</li>
                    ...
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">Amazon Web Services</li>
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">Google Cloud Platform</li>
                    ...
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">ElasticSearch</li>
                    <li className="p-4 m-2 bg-cyan-400 rounded-xl">Microservices</li>
